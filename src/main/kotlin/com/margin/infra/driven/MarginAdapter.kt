...
class MarginAdapter : MarginSpi {
    ...
    override fun getMinimumNumberOfWorkingDaysForExcessMargin(employee: Employee, margin: Int): Int {
        return (1 + (employee.annualGrossSalary * 1.5 + margin) / employee.averageDailyRate).roundToInt()
    }
}
